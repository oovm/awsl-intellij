...
public class AwslParser implements PsiParser, LightPsiParser {
  ...
  public static boolean generic(PsiBuilder b, int l) {
    ...
    GeneratedParserUtilBase.exit_section_(b, m, GENERIC, r);
    return r;
  }

  // SYMBOL [generic]
  private static boolean generic_1(PsiBuilder b, int l) {
    if (!GeneratedParserUtilBase.recursion_guard_(b, l, "generic_1")) return false;
    boolean r;
    Marker m = GeneratedParserUtilBase.enter_section_(b);
  ...
  private static boolean generic_1_1(PsiBuilder b, int l) {
    if (!GeneratedParserUtilBase.recursion_guard_(b, l, "generic_1_1")) return false;
    generic(b, l + 1);
    return true;
  }
  ...
  public static boolean html_code(PsiBuilder b, int l) {
    ...
    r = r && html_end(b, l + 1);
    GeneratedParserUtilBase.exit_section_(b, m, HTML_CODE, r);
    return r;
  }
  ...
  public static boolean html_end(PsiBuilder b, int l) {
    ...
    GeneratedParserUtilBase.exit_section_(b, m, HTML_END, r);
    return r;
  }
  ...
  private static boolean html_inner_1_0(PsiBuilder b, int l) {
    if (!GeneratedParserUtilBase.recursion_guard_(b, l, "html_inner_1_0")) return false;
    boolean r;
    Marker m = GeneratedParserUtilBase.enter_section_(b);
  ...
  private static boolean html_inner_1_0_1(PsiBuilder b, int l) {
    if (!GeneratedParserUtilBase.recursion_guard_(b, l, "html_inner_1_0_1")) return false;
    boolean r;
    r = consumeToken(b, SYMBOL);
  ...
  public static boolean html_kv(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = GeneratedParserUtilBase.enter_section_(b);
    r = GeneratedParserUtilBase.consumeTokens(b, 0, SYMBOL, EQ, STRING);
    GeneratedParserUtilBase.exit_section_(b, m, HTML_KV, r);
    return r;
  }
  ...
  public static boolean html_self_close(PsiBuilder b, int l) {
    ...
    if (!GeneratedParserUtilBase.nextTokenIs(b, "<html self close>", HTML_START_CODE_L, HTML_START_TEXT_L)) return false;
    boolean r;
    Marker m = GeneratedParserUtilBase.enter_section_(b, l, GeneratedParserUtilBase._NONE_, HTML_SELF_CLOSE, "<html self close>");
  ...
  public static boolean html_start_code(PsiBuilder b, int l) {
    ...
    GeneratedParserUtilBase.exit_section_(b, m, HTML_START_CODE, r);
    return r;
  }
  ...
  public static boolean html_start_text(PsiBuilder b, int l) {
    ...
    r = r && consumeToken(b, HTML_START_R);
    GeneratedParserUtilBase.exit_section_(b, m, HTML_START_TEXT, r);
    return r;
  }
  ...
  public static boolean html_text(PsiBuilder b, int l) {
    ...
    r = r && html_end(b, l + 1);
    GeneratedParserUtilBase.exit_section_(b, m, HTML_TEXT, r);
    return r;
  }
