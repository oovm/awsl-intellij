...
import awsl.intellij.language.psi.AwslPattern;
...
public class AwslPatternNode extends AwslAstNode implements AwslPattern {

  public AwslPatternNode(@NotNull ASTNode node) {
    super(node);
  }
