...
import awsl.intellij.language.psi.AwslStringLiteral;
...
public class AwslStringLiteralNode extends AwslAstNode implements AwslStringLiteral {

  public AwslStringLiteralNode(@NotNull ASTNode node) {
    super(node);
  }
