...
import awsl.intellij.language.psi.AwslHtmlEscape;
...
public class AwslHtmlEscapeNode extends AwslAstNode implements AwslHtmlEscape {

  public AwslHtmlEscapeNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AwslVisitor visitor) {
    visitor.visitHtmlEscape(this);
  }
