...
class JssConvertJson : CreateFileAction(name, description, AwslIconProvider.AwslFile) {
    companion object {
        private val name = com.github.awsl_lang.AwslBundle.message("action.convert_html")
        private val description = com.github.awsl_lang.AwslBundle.message("action.convert_html.description")
